...
////Variables and Data types in JS
    ...
    let x=10;//int//this will be treated as a global variable,that is even called out of a function.
    let y=20.5;//float
    let z="Hello World";//string
    let is_true=true;//boolean
    let is_false=false;//boolean
    let n=null;//null
...
/////Ternary operator:
    ...
    // let prevess = (age >= 18) ? 'granted' : 'denied';
...
/////String methods:
    ...
    //Template literals:
    let name1 = "Alice";
    let greeting = `Hello, ${name1}! Welcome to JS.`;//use of template literals
...
////OOPS:
	...
	let ford2 =new Car2("ford");
	console.log(ford2.start());
